...
export const NOTATION_HTML = `
          ...
          <div class="notation-group">
            ...
            <div class="glyph-grid">
              ...
              <div class="glyph-row"><span class="g">□<i>n</i></span><span class="m">the <b>expected chapter mark</b> — a not-yet-mined block cited by the place it will take: from the queue, where the number holds only while the queue does, or from a height consensus has already fixed (the appendix's provisional chapters), where the number is as firm as any citation and only its block is missing (a bare □ in a transaction's margin is the no-locktime mark)</span></div>
