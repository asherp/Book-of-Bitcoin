...
export const NOTATION_HTML = `
          ...
          <div class="notation-group">
            ...
            <div class="glyph-grid">
              ...
              <div class="glyph-row" data-marks="re:256[⁰¹²³⁴⁵⁶⁷⁸⁹]"><span class="g"><i>p</i>·<i>q</i>…×256<sup><i>e</i></sup></span><span class="m">the target written <b>exactly</b>, in the two parts nBits is made of: its <b>mantissa in primes</b>, times the whole-byte <b>shift</b> it rides on. The centred dot is multiplication; a raised digit is a prime repeated, and a prime appearing once carries no power at all. 256<sup><i>e</i></sup> is the target's scale, said in the unit the header keeps it in — a retarget moves it by whole bytes — and the primes before it are the mantissa, the twenty-odd bits a window's work is actually chosen from. Genesis says it plainest: 65535 is 2¹⁶−1, so its mantissa is 3·5·17·257, the Fermat primes. Its leading zeros are β's demand. The early coinbase preamble carries the same pair</span></div>
              <div class="glyph-row" data-marks="η*"><span class="g">η<i>p</i>·<i>q</i>…</span><span class="m">the <b>nonce</b> the miner landed on, factored as the target on the line above it is — the same notation, since it is the same kind of thing: a number, written as what it is made of. The contrast is the reading. A target is a small mantissa on a scale of whole bytes, chosen; a nonce is two or three arbitrary primes, one of them usually enormous, and that shapelessness is exactly what a nonce is — a place in the search, arrived at by counting, meaning nothing in itself</span></div>
