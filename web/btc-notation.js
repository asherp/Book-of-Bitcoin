...
export const NOTATION_HTML = `
          ...
          <div class="notation-group">
            ...
            <div class="glyph-grid">
              ...
              <div class="glyph-row"><span class="g">η<i>n</i> · η<sub><i>n</i></sub></span><span class="m"><b>extranonce</b> — search space beyond the header's η, the counter a miner rolls once the header's 32 bits are exhausted. It follows the opening mark in either era: behind ■ from BIP34 on, behind β before it. Read as the number it is, like the header's own nonce — which also keeps it out of the margin below, where a counter's bytes are entropy and better than a third of them pass for printable text by chance. The value rides inline where it is long, and as a subscript in the early blocks, where an extranonce is a single digit</span></div>
