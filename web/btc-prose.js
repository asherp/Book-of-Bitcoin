...
// gets one form -- an early block's η₄ and a modern eight-byte counter are the
// same field under the same rule, and a mark that changed shape with the size
// of its number would be two marks wearing one glyph. Both call sites come
...
// a meaning the bytes never stated. templateTimePush now takes that number
// first, and this stays what its name says.
