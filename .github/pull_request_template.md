<!--
Offering commentary — a note on a passage, a name for a transaction, a
correction to the historical record? This is the wrong form. Open the pull
request with `?template=commentary.md&expand=1` on the end of the compare URL
and you will get the one that asks about the passage and the reading instead.
If you arrived here from "Add your commentary" on a page, that route cannot
carry the parameter: delete this form and paste in
.github/PULL_REQUEST_TEMPLATE/commentary.md, or say in a sentence what passage
you are annotating and it can be sorted out in review.

Everything else — the pages, the notation, the tooling, the tests — belongs
here. CONTRIBUTING.md is the long form; this is the short form, to fill in.
