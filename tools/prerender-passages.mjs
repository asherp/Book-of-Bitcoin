...
import { init, encodeCanonical } from '../web/glossia-msg.js';
...
const proseOf = (hex) => encodeCanonical(hex, 'english', BEST_OF).prose;
...
export function sitemapXml(rendered, outputPaths = []) {
  const pages = [
    ...
    'bitcoin-appendix.html?part=mempool', 'bitcoin-appendix.html?part=consensus',
